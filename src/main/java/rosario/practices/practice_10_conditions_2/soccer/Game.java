...
package rosario.practices.practice_10_conditions_2.soccer;

import rosario.practices.practice_10_conditions_2.utility.GameUtils;
    ...
    public String getDescription() {
        ...
        for (Goal currGoal: this.getGoals()) {
            ...
            if (currGoal.getTheTeam()== homeTeam) {
                homeTeamGoals++;
                homeTeam.goalsTotalInc(1);
            } else {
                awayTeamGoals++;
                awayTeam.goalsTotalInc(1);
            }
